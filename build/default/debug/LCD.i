...
void comando(unsigned char dado) {
    ...
    LATDbits.LATD4 = (dado & 0x10) >> 4;
    LATDbits.LATD5 = (dado & 0x20) >> 5;
    LATDbits.LATD6 = (dado & 0x40) >> 6;
    LATDbits.LATD7 = (dado & 0x80) >> 7;
    ...
    LATDbits.LATD4 = (dado & 0x01);
    LATDbits.LATD5 = (dado & 0x02) >> 1;
    LATDbits.LATD6 = (dado & 0x04) >> 2;
    LATDbits.LATD7 = (dado & 0x08) >> 3;
